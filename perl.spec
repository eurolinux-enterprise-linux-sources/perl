...
# remove nofork option from prove's documentation
Patch17:        perl-5.10.1-prove_nofork.patch
# 640720 77352: Memory leaks in threaded Perl (cloning PVGVs and PL_my_cxt_list)
Patch18:        perl-5.10.1-rt77352.patch
# lc launders tainted flag http://rt.perl.org/rt3//Public/Bug/Display.html?id=87336
# CVE-2011-1487 and bug #698552
Patch19:        perl-5.10.1-lc_launders_taint.patch
# 743010 - perl: code injection vulnerability in Digest->new()
Patch20:        perl-5.10.1-Digest_vulnerability.patch
# CVE-2011-2939 Perl 5.{10,12,14} heap overflow while decoding Unicode string
Patch21:        perl-5.10.1-CVE-2011-2939.patch
# Fix bug RHZB#805606, RT#73520, upstream commit c4bc4aaa
Patch22:        perl-5.8.8-RT-73520-POSIX-strftime-memory-leak.patch
# Fix bug RHBZ#720644, work-around for RT#94560 not to break ABI,
# related to CVE-2012-5195
Patch23:        perl-5.10.1-Do-not-wrap-count-argument-of-Perl_repeatcpy.patch
# Fix bug RHBZ#720644, needed on 32-bit user space
Patch24:        perl-5.10.1-Do-not-wrap-number-of-bytes-to-copy-silently.patch
# Fix CVE-2013-1667 (DoS in rehashing code)
Patch25:        perl-5.10.1-CVE-2013-1667.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch26:        perl-5.10.1-perl-22977-Bug-in-format-write.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch27:        perl-5.10.1-Don-t-let-formats-outlive-their-outer-subs.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch28:        perl-5.10.1-Formats-in-closures-called-outside-closures-crash.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch29:        perl-5.10.1-Cloning-a-format-whose-outside-has-been-undefined.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch30:        perl-5.10.1-Don-t-crash-with-formats-in-special-blocks.patch
# Move format to prototyped subroutine properly, bug #920132, RT#50528,
# RT#22977
Patch31:        perl-5.10.1-Don-t-leak-formats-defined-inside-subs.patch
# Fix memory leak when accessing non-matched named capturing groups,
# bug #767608, RT#78266
Patch32:        perl-5.14.2-Don-t-leak-memory-when-accessing-named-capt.patch
# Do not crash if declared DESTROY method has not been defined, bug #839788,
# RT#71952
Patch33:        perl-5.10.1-Fix-a-NULL-pointer-dereference-when-looking-for-a-DE.patch
# Fix find2perl to translate ? glob properly, bug #825713, RT#113054
Patch34:        perl-5.14.2-find2perl-transtate-question-mark-properly.patch

# Fix perl segfaults in Perl_csighandler with custom signal handler
# Bug #991852, RT#60724
Patch35:        perl-5.12.5-Unregister-signal-handler-before-destroying-my_.patch
...
%define                     Compress_Raw_Bzip2_version 2.021
%define                     Compress_Raw_Zlib_version 2.021
%define                     Compress_Zlib_version 2.021
%define                     CPAN_version 1.9402
%define                     CPANPLUS_version 0.88
%define                     CGI_version 3.51
...
%define                     IO_Compress_Base_version 2.021
%define                     IO_Compress_Bzip2_version 2.021
%define                     IO_Compress_Zlib_version 2.021
...
Patch113:       perl-update-threads.patch
# Upgrade IO-Compress from 2.020 to 2.021, bug #810469
Patch114:       perl-update-IO-Compress.patch
# Upgrade Compress-Raw-Bzip2 from 2.020 to 2.021, bug #810469
Patch115:       perl-update-Compress-Raw-Bzip2.patch
# Upgrade Compress-Raw-Zlib from 2.020 to 2.021, bug #810469
Patch116:       perl-update-Compress-Raw-Zlib.patch
...
# Bug #806373, fixed in upstream IO-Compress-2.030
Patch202:       perl-5.10.1-Fix-IO-Uncompress-Unzip-nextStream-to-return-0-on-la.patch
# Fix CVE-2012-5526 (new-lines in Cookie and P3P headers)
Patch203:       perl-5.10.1-CVE-2012-5526.patch
# Fix CVE-2012-6329 (code execution via Locale::Maketext)
Patch204:       perl-5.10.1-CVE-2012-6329.patch
# Set default output for Pod::Man and Pod::Text parse_file() methods,
# bug #819042, CPAN RT#77032, CPAN RT#77530
Patch205:       perl-5.10.1-Override-the-Pod-Simple-parse_file.patch
...
# For perl-5.10.1-perl-22977-Bug-in-format-write.patch
...
Requires:       perl-Archive-Extract, perl-Archive-Tar, perl-CGI,
...
# Configure Compress::Raw::Bzip2 to use system bzlib
sed -i 's|^my $BUILD_BZIP2 = .*|my $BUILD_BZIP2 = 0;|
        s|^my $BZIP2_LIB = .*|my $BZIP2_LIB = "%{_libdir}";|
        s|^my $BZIP2_INCLUDE = .*|my $BZIP2_INCLUDE = "%{_includedir}";|' \
...
%endif
        ...
        -Dscriptdir='%{_bindir}' \
        -Dusesitecustomize
# Regenerate parser, for perl-5.10.1-perl-22977-Bug-in-format-write.patch
make regen_perly
...
%endif \
       ...
       'RHEL Patch17: remove unsupported fork as option from documentation' \
       'RHEL Patch18: fix RT 77352: Memory leaks in threaded Perl'\
	   'RHEL Patch19: CVE-2011-1487 RT#87336'\
	   'RHEL Patch20: code injection vulnerability in Digest->new()' \
	   'RHEL Patch21: CVE-2011-2939 heap overflow while decoding Unicode string' \
       'RHEL Patch22: Fix POSIX::strftime memory leak' \
       'RHEL Patch23: Do not wrap count argument of Perl_repeatcpy()' \
       'RHEL Patch24: Do not wrap count argument of Perl_repeatcpy() on i386' \
       'RHEL Patch25: Fix CVE-2013-1667 DoS in rehashing code' \
       'RHEL Patch26: Move format to prototyped subroutine properly [1]' \
       'RHEL Patch27: Move format to prototyped subroutine properly [2]' \
       'RHEL Patch28: Move format to prototyped subroutine properly [3]' \
       'RHEL Patch29: Move format to prototyped subroutine properly [4]' \
       'RHEL Patch30: Move format to prototyped subroutine properly [5]' \
       'RHEL Patch31: Move format to prototyped subroutine properly [6]' \
       'RHEL Patch32: Fix memory leak when accessing non-matched named captures' \
       'RHEL Patch33: Do not crash if declared DESTROY method has not been defined' \
       'RHEL Patch34: Fix find2perl to translate ? glob properly' \
       'RHEL Patch35: Fix perl segfaults in Perl_csighandler with custom signal handler' \
       ...
       'RHEL Patch113: Update threads to %{threads_version}' \
       'RHEL Patch114: Update IO-Compress to %{IO_Compress_Base_version}' \
       'RHEL Patch115: Update Compress-Raw-Bzip2 to %{Compress_Raw_Bzip2_version}' \
       'RHEL Patch116: Update Compress-Raw-Zlib to %{Compress_Raw_Zlib_version}' \
       'RHEL Patch201: Fix Archive::Tar to return correct code on error' \
       'RHEL Patch202: Fix IO::Uncompress::Unzip::nextStream to return 0 on last stream' \
       'RHEL Patch203: Fix CVE-2012-5526 new-lines in Cookie and P3P headers' \
...
%exclude %dir %{archlib}/IO/Compress/Adapter/
%exclude %{archlib}/IO/Compress/Base/
%exclude %{archlib}/IO/Compress/Base.pm
%exclude %dir %{archlib}/IO/Uncompress/Adapter/
...
# IO::Compress::Bzip2
%exclude %{archlib}/IO/Compress/Adapter/Bzip2.pm
%exclude %{archlib}/IO/Compress/Bzip2.pm
%exclude %{archlib}/IO/Uncompress/Adapter/Bunzip2.pm
%exclude %{archlib}/IO/Uncompress/Bunzip2.pm
%exclude %{_mandir}/man3/IO::Compress::Bzip2*
%exclude %{_mandir}/man3/IO::Uncompress::Bunzip2*

# IO::Compress::Zlib
%exclude %{archlib}/IO/Compress/Adapter/Deflate.pm
%exclude %{archlib}/IO/Compress/Adapter/Identity.pm
...
%exclude %{archlib}/IO/Uncompress/Adapter/Identity.pm
%exclude %{archlib}/IO/Uncompress/Adapter/Inflate.pm
...
%dir %{archlib}/IO/Compress/Adapter/
%{archlib}/IO/Compress/Base/
%{archlib}/IO/Compress/Base.pm
%dir %{archlib}/IO/Uncompress/Adapter/
...
%defattr(-,root,root,-)
%{archlib}/IO/Compress/Adapter/Bzip2.pm
%{archlib}/IO/Compress/Bzip2.pm
%{archlib}/IO/Uncompress/Adapter/Bunzip2.pm
%{archlib}/IO/Uncompress/Bunzip2.pm
%{_mandir}/man3/IO::Compress::Bzip2*
%{_mandir}/man3/IO::Uncompress::Bunzip2*

%files IO-Compress-Zlib
%defattr(-,root,root,-)
%{archlib}/IO/Compress/Adapter/Deflate.pm
%{archlib}/IO/Compress/Adapter/Identity.pm
...
%{archlib}/IO/Uncompress/Adapter/Identity.pm
%{archlib}/IO/Uncompress/Adapter/Inflate.pm
...
* Thu Jul 18 2013 Jitka Plesnikova <jplesnik@redhat.com> - 4:5.10.1-135
- Resolves: #985791 - Add BR perl-CGI to perl-core

* Tue Jun 11 2013 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-134
- Resolves: #973022 - Make non-option handler for Getopt::Long::GetOptions()
  compatible with XML::Simple

* Wed Jun 05 2013 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-133
- Resolves: #698552 - Correct taintedness tests
- Resolves: #825713 - Fix find2perl to translate ? glob properly
- Resolves: #810469 - Upgrade IO-Compress, Compress-Raw-Bzip2, and
  Compress-Raw-Zlib to 2.021
- Resolves: #819042 - Set default output for Pod::Man and Pod::Text
  parse_file() methods
- Resolves: #905482 - Require glibc-devel, gdbm-devel, db4-devel by perl-devel

* Tue Jun 04 2013 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-132
- Resolves: #767608 - Fix memory leak when accessing non-matched named
  capturing groups
- Resolves: #839788 - Do not crash if declared DESTROY method has not been
  defined

* Mon Mar 11 2013 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-131
- Resolves: #920132 - Move format to prototyped subroutine properly

* Mon Mar 04 2013 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-130
- Resolves: #915693 - CVE-2012-5526 (newline injection due to improper CRLF
  escaping in Set-Cookie and P3P headers)
- Resolves: #915693 - CVE-2012-6329 (possible arbitrary code execution via
  Locale::Maketext)
- Resolves: #915693 - CVE-2013-1667 (DoS in rehashing code)

* Tue Dec 04 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-129
- Related: #720644 - Do not wrap count argument of Perl_repeatcpy() on i386

* Fri Oct 12 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-128
- Resolves: #720644 - Do not wrap count argument of Perl_repeatcpy()

* Mon Apr 30 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-127
- Resolves: rhbz#817480 - Enable usesitecustomize
- Resolves: rhbz#817549 - Fix t/io/errno.t test

* Tue Mar 27 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-126
- Resolves: rhbz#806373 - Fix IO::Uncompress::Unzip::nextStream to return 0 on
  last stream

* Thu Mar 22 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-125
- Resolves: rhbz#805606 - Fix POSIX::strftime memory leak

* Mon Mar 12 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-124
- Resolves: rhbz#801804 - Correct version of perl-Compress-Raw-Zlib sub-package

* Tue Mar 06 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-122
- Resolves: rhbz#738421 - Package bzip2 modules
- Resolves: rhbz#750145 - Add require EE::MM into IPC::Cmd

* Wed Feb 15 2012 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-121
- Resolves: rhbz#707960, rhbz#717565 - Do not own site directories located in
  /usr/local

* Tue Oct  4 2011 Marcela Mašláňová <mmaslano@redhat.com> - 4:5.10.1-120
- 731246 (CVE-2011-2939)CVE-2011-2939 heap overflow - decoding Unicode string
- 743010 - perl: code injection vulnerability in Digest->new()
- Resolves: rhbz#743093, rhbz#743091

* Tue Apr 19 2011 Marcela Mašláňová <mmaslano@redhat.com> - 4:5.10.1-119
- 692862 - lc launders tainted flag, CVE-2011-1487
- make SOURCE1 executable, because it missed +x in brew
- Resolves: rhbz#692862

* Mon Feb 14 2011 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-118
- Correct perl-5.10.1-rt77352.patch
- Related: rhbz#640720

* Fri Jan 21 2011 Marcela Mašláňová <mmaslano@redhat.com> - 4:5.10.1-117
- 671352 CGI-3.51 security update
- Resolves: rhbz#671352

* Wed Jan  5 2011 Marcela Mašláňová <mmaslano@redhat.com> - 4:5.10.1-116
...
* Fri Jul 16 2010 Petr Pisar <ppisar@redhat.com> - 4:5.10.1-114
